...
region1-snets = {
  "appprod" = {
    "snet-app-prod-resources-01" = {
      address_prefixes = ["10.96.104.64/27"]
      routetable = true
      default_outbound_access_enabled = false
      nsg_ruleset = {
      }
    }
    "snet-app-prod-appgw-01" = {
      address_prefixes = ["10.96.104.128/27"]
      routetable = false
      default_outbound_access_enabled = false
      nsg_ruleset = {
        in-public-https = {
    ...
    "snet-app-prod-containerapps-01" = {
      address_prefixes = ["10.96.106.0/27"]
      routetable = true
      default_outbound_access_enabled = false
      nsg_ruleset = {}
      delegation = [
